...
```text
src/public/      Browser app assets
src/server/      Node HTTP server
data/            Repo-safe example data
deploy/          Docker and Docker Compose files
tests/e2e/       Playwright post-deploy checks
```
